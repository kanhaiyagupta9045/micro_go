...
type ProductCatalog struct {
	...
	Inventory   InventoryCatalog `gorm:"foreignKey:ProductID;references:ProductID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE" json:"inventory"`
